			...
			<fieldset>
				...
				<div class="st1">
					<label for="" class="l1">刊登地區:</label> <select id="selPubArea1"
						name='publishArea' onchange="showCity()">
						<option>請選擇</option>
			...
			<fieldset>
				...
				<div class="st1">
					...
					<textarea cols="40" row="5" name='publishMark'
						value='${param.publishMark}'></textarea>
				</div>
			</fieldset>
