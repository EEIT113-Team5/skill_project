	...
	<div id="layoutSidenav">
		...
		<div id="layoutSidenav_content">
			<main>
				...
				<div class="rounded"
					style="background-color: pink; width: 500px; margin: 10px auto">
					<div style="background-color:#E0E0E0 ;" class="p-3 rounded-top">
						來自<span id="sendto">米津玄師</span>的交換邀請
					</div>
					<div class="card-body">
						<div class="card-text">
							<p>
					...
					<button id="disabled" class="btn btn-primary" onclick='connect();'>接受請求，開啟對話</button>
					...
					<div class="card">
						<div class="card-header msg_head">
							<div class="d-flex bd-highlight">
								<div class="img_cont">
									<img src="images/suda.jpeg" class="rounded-circle user_img">
