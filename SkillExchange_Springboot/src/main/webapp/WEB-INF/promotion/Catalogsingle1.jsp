...
<body class="sb-nav-fixed" onunload="disconnect();">
	...
	<div id="layoutSidenav">
		...
		<div id="layoutSidenav_content">
			<main>
				<div class="rounded-lg" style="background-color: pink; width: 500px; margin: 10px auto;">
					<div class="card-body">
						<h4 class="card-title" id='sendto'>菅田將輝</h4>
						<div class="card-text">
							<p>
						...
						<button id="disabled" class="btn btn-primary" onclick='connect();'>有興趣，向對方發起對話請求</button>
					</div>
				</div>
