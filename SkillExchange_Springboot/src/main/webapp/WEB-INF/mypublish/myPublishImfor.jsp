...
<body id="body">
	...
	<section class="single-page-header">
		<div class="container">
			<div class="row">
				<div class="col-md-12">
					<h2 style="font-family: 微軟正黑體;">刊登詳情</h2>
				</div>
			</div>
		</div>
	</section>
	<div class="container">
			...
			<div style="width: 1200px;">
				<div style="float: right; margin-top: 10px; width: 300px">
					...
					<div style="border: 1px dashed black; margin: 20px; padding: 10px">
						<c:forEach varStatus="comm" var="commList" items="${commList}">
							<div>
								<div
									onclick="location.href='publish?num=${commList.publishNo}&hostid=${skills.memberRegNo}&status=0'"
									style="font-size: 30px">推薦序:${comm.index+1}</div>
								<div
									onclick="location.href='publish?num=${commList.publishNo}&hostid=${skills.memberRegNo}&status=0'">
									<img src="${commList.publishPic}" height="50px" />
								</div>
								<div
									onclick="location.href='publish?num=${commList.publishNo}&hostid=${skills.memberRegNo}&status=0'">標題:${commList.myTitle}</div>
								<div>-----------------------------------</div>
							</div>
						</c:forEach>
					</div>
				...
				<div class="resume" style="width: 800px; margin-right: auto;">
					<div class="publishleft"
						style="display: inline-block; height: 780px">
						...
						<p class="imformation">
							<b>刊登地區:${mylistimfor.myArea}</b><br>
							<br> <b>希望地點:${mylistimfor.myPlace}</b><br>
							<br> <br> <b>刊登地點:${mylistimfor.myCity}</b><br>
							<br> <b>刊登鄉鎮:${mylistimfor.myDistrict}</b><br>
							<br> <b>刊登路名:${mylistimfor.myRoad}</b><br>
							<br>
						</p>
						<div class="icon"></div>
					</div>
					<div class="publishright" style="display: inline-block;height: 780px">
		...
		<div class="container" style="width: 300px;padding-bottom:10px">
			<form action="myPublish" method="GET"
				enctype="application/x-www-form-urlencoded">
				<input type='submit' value='我的刊登' style="margin-top: 10px">
			</form>
		</div>
	</div>
