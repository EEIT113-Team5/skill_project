...
@Entity
@Table(name = "Activity")
public class ActivityBeantwo implements Serializable {
	...
	public ActivityBeantwo() {

	}

	public ActivityBeantwo(int activityid, int memberid, String title, String category, String descript, String beginDay,
	...
	public ActivityBeantwo(int memberid, String title, String category, String descript, String beginDay, String beginTime,
