...
public class CommentBean {
	...
	public String toString() {
		return "CommentBean [commentNo=" + commentNo + ", commentorNo=" + commentorNo + ", memberName=" + memberName
				+ ", msgTime=" + msgTime + ", webGrading=" + webGrading + ", webFluency=" + webFluency + ", webSatis="
				+ webSatis + ", webRecommend=" + webRecommend + ", webSugg=" + webSugg + ", exGrading=" + exGrading
				+ ", memCommented=" + memCommented + ", msgDetail=" + msgDetail + ", stat=" + stat + "]";
	}
